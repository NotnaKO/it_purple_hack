#!/bin/bash
sudo -u igor psql -d postgres -a -f baseline_matrix_1.sql #Ubuntu only
sudo -u igor psql -d postgres -a -f baseline_matrix_2.sql
sudo -u igor psql -d postgres -a -f baseline_matrix_3.sql
